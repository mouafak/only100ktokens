...
const TrtrInput = () => {
  ...
  useEffect(() => {
    const trtrAmount = Number(ethValue) * 1e6;
  ...
  return (
    <div className=" relative flex flex-col bg-custom-blue p-2">
      ...
      <div className="  m-0 bg-custom-blue rounded-none text-white text-3xl font-medium outline-none border-none h-16 flex items-center relative px-2">
